...
const CookiesBanner = () => {
  ...
  if (show === undefined) {
    return (
      <div className="sticky bottom-0 z-10 w-screen min-h-28 px-5 py-7 mx-sc bg-gray-100 border-t-2 border-pink-400 shadow-md dark:bg-gray-800 dark:border-pink-600  dark:text-opacity-80">
